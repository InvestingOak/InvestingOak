...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InvestingOak.Data.Entities.PaperTrading.Leg", b =>
            {
                b.Property<int>("Id")
                    .ValueGeneratedOnAdd()
                    .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("InvestingOak.Data.Entities.PaperTrading.Position", b =>
            {
                b.Property<int>("Id")
                    .ValueGeneratedOnAdd()
                    .HasColumnType("INTEGER");

                b.Property<DateTimeOffset>("Close")
                    .HasColumnType("TEXT");
                ...
                b.Property<DateTimeOffset>("Open")
                    .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("InvestingOak.Data.Entities.PaperTrading.Project", b =>
            {
                b.Property<int>("Id")
                    .ValueGeneratedOnAdd()
                    .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("InvestingOak.Data.Entities.StockData.ArticleList", b =>
            {
            ...
            modelBuilder.Entity("InvestingOak.Data.Entities.StockData.CompanyProfile", b =>
            {
                b.Property<string>("Symbol")
                    .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("InvestingOak.Data.Entities.StockData.NewsArticle", b =>
            {
            ...
            modelBuilder.Entity("InvestingOak.Data.Entities.StockData.PriceTargets", b =>
            {
                b.Property<string>("Symbol")
                    .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("InvestingOak.Data.Entities.StockData.Quote", b =>
            {
                b.Property<string>("Symbol")
                    .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("InvestingOak.Data.Entities.StockData.Recommendations", b =>
            {
                b.Property<string>("Symbol")
                    .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("InvestingOak.Data.Entities.StockData.Sentiment", b =>
            {
                b.Property<string>("Symbol")
                    .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("InvestingOak.Data.Entities.StockData.StockSymbol", b =>
            {
                b.Property<string>("Symbol")
                    .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("InvestingOak.Data.Entities.StockData.SymbolList", b =>
            {
                b.Property<string>("Exchange")
                    .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("InvestingOak.Data.Entities.PaperTrading.OptionTrade", b =>
            {
                b.HasBaseType("InvestingOak.Data.Entities.PaperTrading.Position");

                b.HasDiscriminator().HasValue("OptionTrade");
            });

            modelBuilder.Entity("InvestingOak.Data.Entities.PaperTrading.StockTrade", b =>
            {
                b.HasBaseType("InvestingOak.Data.Entities.PaperTrading.Position");
            ...
            modelBuilder.Entity("InvestingOak.Data.Entities.PaperTrading.Leg", b =>
            {
                b.HasOne("InvestingOak.Data.Entities.PaperTrading.OptionTrade", null)
                    .WithMany("Legs")
            ...
            modelBuilder.Entity("InvestingOak.Data.Entities.PaperTrading.Position", b =>
            {
                b.HasOne("InvestingOak.Data.Entities.PaperTrading.Project", null)
                    .WithMany("Positions")
            ...
            modelBuilder.Entity("InvestingOak.Data.Entities.StockData.NewsArticle", b =>
            {
                b.HasOne("InvestingOak.Data.Entities.StockData.ArticleList", null)
                    .WithMany("Articles")
            ...
            modelBuilder.Entity("InvestingOak.Data.Entities.StockData.StockSymbol", b =>
            {
                b.HasOne("InvestingOak.Data.Entities.StockData.SymbolList", null)
                    .WithMany("Symbols")
            ...
            modelBuilder.Entity("InvestingOak.Data.Entities.PaperTrading.Project", b => { b.Navigation("Positions"); });

            modelBuilder.Entity("InvestingOak.Data.Entities.StockData.ArticleList", b => { b.Navigation("Articles"); });

            modelBuilder.Entity("InvestingOak.Data.Entities.StockData.SymbolList", b => { b.Navigation("Symbols"); });

            modelBuilder.Entity("InvestingOak.Data.Entities.PaperTrading.OptionTrade", b => { b.Navigation("Legs"); });
